...
namespace PartyPlannerV2.Controllers
{
    public class CashiersController : Controller
    {
        ...
        public CashiersController(PartyPlannerDbV2 context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cashiers != null ? 
                          ...
                          Problem("Entity set 'PartyPlannerDbV2.Cashiers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PartyPlannerDbV2.Cashiers'  is null.");
            }
            var cashier = await _context.Cashiers.FindAsync(id);
            if (cashier != null)
            {
