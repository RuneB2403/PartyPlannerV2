...
namespace PartyPlannerV2.Controllers
{
    public class ParticipantsController : Controller
    {
        ...
        public ParticipantsController(PartyPlannerDbV2 context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Participants != null ? 
                          ...
                          Problem("Entity set 'PartyPlannerDbV2.Participants'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PartyPlannerDbV2.Participants'  is null.");
            }
            var participant = await _context.Participants.FindAsync(id);
            if (participant != null)
            {
