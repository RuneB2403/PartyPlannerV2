...
namespace PartyPlannerV2.Controllers
{
    public class OrganizersController : Controller
    {
        ...
        public OrganizersController(PartyPlannerDbV2 context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Organizers != null ? 
                          ...
                          Problem("Entity set 'PartyPlannerDbV2.Organizers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PartyPlannerDbV2.Organizers'  is null.");
            }
            var organizer = await _context.Organizers.FindAsync(id);
            if (organizer != null)
            {
